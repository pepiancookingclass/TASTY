-- =====================================================
-- FIX: SISTEMA DE EMAILS DE BIENVENIDA - TASTY
-- Corregir error en índices
-- =====================================================
...
Email: soporte@tasty.gt';
  ...
  -- Log del email enviado (solo si la tabla existe)
  BEGIN
...
EXCEPTION
  WHEN OTHERS THEN
    -- Log del error (solo si la tabla existe)
    BEGIN
      INSERT INTO email_logs (
        user_id,
        email_type,
...
-- Índices para la tabla de logs (CORREGIDOS)
CREATE INDEX IF NOT EXISTS idx_email_logs_user_id ON email_logs(user_id);
CREATE INDEX IF NOT EXISTS idx_email_logs_type ON email_logs(email_type);
CREATE INDEX IF NOT EXISTS idx_email_logs_status ON email_logs(status); -- CORREGIDO: era email_status
