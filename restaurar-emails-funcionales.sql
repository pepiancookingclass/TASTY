-- =====================================================
-- RESTAURAR EMAILS FUNCIONALES + FUNCIÓN SEPARADA CREADORES
-- Solución: 2 funciones independientes
-- =====================================================

-- 1. RESTAURAR FUNCIÓN ORIGINAL (cliente + admin)
...
-- =====================================================
-- 2. FUNCIÓN SEPARADA SOLO PARA CREADORES
-- =====================================================
...
BEGIN
  RAISE NOTICE '👥 INICIANDO EMAILS A CREADORES PARA ORDEN: %', order_uuid;
  ...
  RAISE NOTICE '🎉 TODOS LOS EMAILS DE CREADORES ENVIADOS PARA ORDEN: %', order_uuid;
