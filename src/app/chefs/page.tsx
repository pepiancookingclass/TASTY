...
export default function CreatorsPage() {
    ...
    const creators: Creator[] = [
        sampleCreator,
        { id: 'creator-002', name: 'Alain Savory', email: 'alain.s@tastyapp.com', profilePictureUrl: 'https://images.unsplash.com/photo-1583394293214-28ded15ee548', imageHint: 'chef portrait', gender: 'male' },
    ];
